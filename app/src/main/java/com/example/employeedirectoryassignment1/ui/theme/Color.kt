package com.example.employeedirectoryassignment1.ui.theme
...
val ColorScheme.textFieldContainer
    @Composable
    get() = if (isSystemInDarkTheme()) BlueGray.copy(alpha = 0.6f) else LightBlueWhite.copy(alpha = 0.6f)

val ColorScheme.buttonContainer
    @Composable
    get() = if (isSystemInDarkTheme()) BlueGray else Black

val ColorScheme.buttonText
    @Composable
    get() = Color.White
