...
@Composable
fun LoginScreenIT(navController: NavHostController) {
    // Mahima
    // you can use 'Login screen' from 'Employee Directory' with its registration function as a base to work with
